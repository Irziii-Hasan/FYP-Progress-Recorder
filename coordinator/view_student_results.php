...
<tbody>
    <tr>
        <td id="edit_s_no">1</td>
        <td id="edit_project_id_display"></td>
        <td id="edit_project_title_display"></td>
        <td id="edit_student_name_display"></td>
        <td>
    <input type="number" id="edit_obtained_marks" name="total_marks" class="form-control" 
           min="0" max="<?php echo htmlspecialchars($record['total']); ?>" required>
</td>
        <td>
            <input type="number" id="edit_total_marks" name="total" class="form-control" required readonly>
        </td>
        <td>
            <input type="number" id="edit_gpa" name="gpa" step="0.01" class="form-control" required readonly>
        </td>
        <td>
            <input type="text" id="edit_grade" name="grade" class="form-control" required readonly>
        </td>
        <td>
    ...
    <?php if (!empty($results)): ?>
        <?php foreach ($results as $index => $record): ?>
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-warning" onclick="showEditTable('<?php echo htmlspecialchars($record['student_id']); ?>', '<?php echo htmlspecialchars($record['project_id']); ?>', '<?php echo htmlspecialchars($record['total_marks']); ?>', '<?php echo htmlspecialchars($record['gpa']); ?>', '<?php echo htmlspecialchars($record['grade']); ?>', '<?php echo htmlspecialchars($record['project_title']); ?>', '<?php echo htmlspecialchars($record['username']); ?>','<?php echo htmlspecialchars($record['total']); ?>')">Edit</button>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else: ?>
