            ...
            <table class="table table-striped">
              ...
              <tbody id="myTable">
                <?php
                  ...
                  $sql = "SELECT Template_id, document_name, file_path, upload_date FROM templates WHERE send_to IN ('all', 'student')";
                  ...
                  if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                          echo "<td>" . $count++ . "</td>";
                          echo "<td><a href='" . $filePath . "' target='_blank'>" . $row["document_name"] . "</a></td>";
                          echo "<td>" . date("d-m-Y", strtotime($row["upload_date"])) . "</td>";
                          echo "<td><a href='" . $filePath . "' class='btn btn-info' download>Download</a></td>";
                          echo "</tr>";
                      }
                  } else {
                      echo "<tr><td colspan='4'>No templates found</td></tr>";
                  }
                  $conn->close();
                ?>
              </tbody>
